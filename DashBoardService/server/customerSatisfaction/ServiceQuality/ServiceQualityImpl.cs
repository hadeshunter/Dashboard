...
{
    public class ServiceQualityImpl : IServiceQuality
    {
        private ICommon m_common;
        private IConfiguration m_configuration;
        public ServiceQualityImpl(ICommon m_common, IConfiguration m_configuration)
        {
        ...
        public dynamic GetData_Dissatisfied_ServiceQuality(RqGrafana rq)
        {
            ...
            {
                var query = "dashboard.TK_KhongHaiLong_CLDV";
                result = SqlMapper.Query<Dissatisfied>(conn, query, param: dyParam, commandType: CommandType.StoredProcedure).AsList<Dissatisfied>();
            }
            return result;
        }

        public dynamic GetData_Dissatisfied_ServiceQuality_Grafana(RqGrafana rq)
        {
            dynamic result = GetData_Dissatisfied_ServiceQuality(rq);
